...
def reflection_phase_correction_estimate(freqs,num_channels):
    ...
    polynomial_coefficients = np.array([-1.2514899715196567e+01,
                                -2.2191453005656960e-07,
                                -1.7638359283659169e-15,
                                1.3952675713463254e-23,
                                2.3593954023607056e-31,
                                -4.3352190887139863e-40,
                                -9.2469755618342609e-48])
