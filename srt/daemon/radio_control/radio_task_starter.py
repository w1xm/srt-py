...
from .radio_process import radio_process_dual_channel
from .radio_save_raw import radio_save_raw
from .radio_save_raw import radio_save_raw_dual_channel
...
class RadioSaveRawTask(RadioTask):
    ...
    def __init__(self, samp_rate, num_channels, root_save_directory, directory):
...
class RadioSaveSpecRadTask(RadioTask):
    ...
    def __init__(self, samp_rate, num_bins, num_channels, root_save_directory, file_name):
    
        print("rad files not currently supported")
...
class RadioSaveSpecFitsTask(RadioTask):
    ...
    fits save task already correctly handles channel count
    """
