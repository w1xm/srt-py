...
# Title: radio_save_spec_fits_dual_channel
...
class radio_save_spec_fits_dual_channel(gr.top_block):

    def __init__(self, directory_name=".", file_name="test.fits", num_bins=4096, samp_rate=2400000):
        gr.top_block.__init__(self, "radio_save_spec_fits_dual_channel", catch_exceptions=True)
...
def main(top_block_cls=radio_save_spec_fits_dual_channel, options=None):
    if options is None:
