...
# Title: Weighted Overlap and FFT
...
class weighted_overlap_fft(gr.hier_block2):
    def __init__(self, fft_window=window.blackmanharris(256), num_bins=256, num_integrations=100000):
        gr.hier_block2.__init__(
            self, "Weighted Overlap and FFT",
                gr.io_signature(1, 1, gr.sizeof_gr_complex*1),
                gr.io_signature(1, 1, gr.sizeof_gr_complex*num_bins),
        )
