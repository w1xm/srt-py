...
class radio_process_dual_channel(gr.top_block):
    ...
    def __init__(self, num_bins=256, num_integrations=100000):
        ...
        self.uhd_usrp_source_1.set_gpio_attr('FP0A', 'OUT', 0x000 , calibrator_mask) #set low
    ...
    def set_cal_on(self, cal_on):
        ...
        self.uhd_usrp_source_1.set_gpio_attr('FP0A', 'OUT', self.cal_on , calibrator_mask) #set to state self.cal_on
        self.uhd_usrp_source_1.clear_command_time()
