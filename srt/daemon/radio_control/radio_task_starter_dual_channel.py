...
from .radio_calibrate import radio_calibrate #we don't actually use this anymore anyway
from .radio_save_raw import radio_save_raw_dual_channel
from .radio_save_spec_rad import radio_save_spec_dual_channel
...
class RadioSaveSpecRadTask(RadioTask):
    ...
    def __init__(self, samp_rate, num_bins, root_save_directory, file_name):
        ...
        super().__init__(
            radio_save_spec_dual_channel.main,
            directory_name=path,
            samp_rate=samp_rate,
            num_bins=num_bins,
            file_name=file_name,
...
class RadioSaveSpecFitsTask(RadioTask):
    ...
    def __init__(self, samp_rate, num_bins, root_save_directory, file_name):
        ...
        path = str(Path(expanduser(root_save_directory)).absolute())
        super().__init__(
            radio_save_spec_fits_dual_channel.main,
            directory_name=path,
            samp_rate=samp_rate,
            num_bins=num_bins,
            file_name=file_name,
