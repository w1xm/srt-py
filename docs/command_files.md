...
Additional Notes:
 ...
 7. Ra/Dec defined from ICRS, expects decimal degrees for both Ra and Dec
 ...
 10. this specifies an angle only, not a 3 dimensional coordinate. You will need to provide your own corrections for parallax if it is significant to your measurement
